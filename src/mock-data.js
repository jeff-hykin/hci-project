...
let events = [
    // store events in sorted order by start time
    {
        ...
        startDateTime: new DateTime([2019, 11, 24, 19, 30]),
    ...
    {
        title: "Lunch with Jeff Bezos",
        tag: "Random",
        description: "Meeting at PIADA",
        position: { lat: 30.624192, lng: -96.339576 },
        startDateTime: new DateTime([2019, 11, 24, 12, 0]),
        endDateTime: new DateTime([2019, 11, 24, 12, 30]),
        index: 2,
    ...
    },
    {
        ...
        endDateTime: new DateTime([2019, 11, 24, 17, 0]),
        index: 5,
        tasks: [
